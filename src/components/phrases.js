...
export const phrases = [
    ...
    {tat: 'Исәнме(сез)!', rus: 'Здравствуй(те)!',  eng: 'Hello' ,audio: isanmesez},
    {tat: 'Хуш!', rus: 'Пока!',  eng: 'Bye' ,audio: hush},
    {tat: 'Сәлам әйт!', rus: 'Передавай привет!',  eng: 'Say Hello' ,audio: salam_ait},
    {tat: 'Рәхмәт!', rus: 'Спасибо!',  eng: 'Thanks' ,audio: rahmat},
    {tat: 'Зинһар!', rus: 'Пожалуйста!',  eng: 'Please' ,audio: zinhar},
    {tat: 'Берни түгел!', rus: 'Ничего не стоит!', eng: 'It costs nothing' , audio: berni_tugel},
    {tat: 'Борчылмагыз', rus: 'Не беспокойтесь', eng: 'Don\'t worry' , audio: borchulmagiz},
    ...
    {tat: 'Һичшиксез!', rus: 'Несомненно',  eng: 'Undoubtedly' ,audio: hichshiksez},
    {tat: 'Кыскасы', rus: 'Короче',  eng: 'In short' ,audio: kyskasi},
    {tat: 'Син (сез) кайда?', rus: 'Где ты (вы)?', eng: 'Where are you' , audio: sinzes_kaida},
    {tat: 'Кая барабыз?', rus: 'Куда пойдём?',  eng: 'Where do we go?' ,audio: kaia_barabiz},
    {tat: 'Хәзер нишлик?', rus: 'Что сейчас будем делать?', eng: 'What are we going to do now?' , audio: hazer_nishlik},
    {tat: 'Ә сез кем?', rus: 'А кто вы?',  eng: 'And who are you?' ,audio: e_sez_kem},
    {tat: 'Шулаймы?', rus: 'Это так?',  eng: 'Is that so?' ,audio: shulaimi},
    {tat: 'Килә аласыңмы?', rus: 'Можешь прийти?', eng: 'Can you come?' , audio: kile_alasinmi},
    {tat: 'Мин бик шат!', rus: 'Я очень рад!', eng: 'I am very happy!' , audio: min_bik_shat},
    {tat: 'Кәефем юк', rus: 'Нет настроения',  eng: 'Not in the mood' ,audio: kaefem_uk},
    {tat: 'Арыдым', rus: 'Я устал(а)',  eng: 'I\'m tired' ,audio: aridim},
    {tat: 'Бу туристлар Америкадан', rus: 'Эти туристы из Америки',  eng: 'These tourists are from America' ,audio: bu_turistlar_amerikadan},
    {tat: 'Хәерле кич', rus: 'Добрый вечер', eng: 'Good evening' , audio: haerle_kich},
    {tat: 'Минем исемем Алсу', rus: 'Меня зовут Алсу', eng: 'My name is Alsu' , audio: minem_isemem_alsu},
    {tat: 'Бу Азатның әтисе', rus: 'Это папа Азата',  eng: 'This is Azat\'s dad' ,audio: bu_azatnin_atise},
    {tat: 'Бик зур рәхмәт', rus: 'Большое спасибо',  eng: 'Thank you very much' ,audio: bik_zur_rahmat},
    {tat: 'Сезгә дә рәхмәт', rus: 'Вам тоже спасибо',  eng: 'Thank you too' ,audio: sezge_de_rehmet},
    {tat: 'Хәлләрең ничек?', rus: 'Как дела?', eng: 'What\'s up?' , audio: hallaren_nichek},
    {tat: 'Гафу итегез', rus: 'Извините',  eng: 'Excuse me' ,audio: gafu_itegez},
    {tat: 'Мин татарча сөйләшәм', rus: 'Я говорю по-татарски', eng: 'I speak Tatar' , audio: min_tatarcha_soileshem},
    ...
    {tat: 'Матур кыз', rus: 'Красивая девочка', eng: 'Beautiful girl' , audio: matur_kyz},
